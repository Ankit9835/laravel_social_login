						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							...
							<div class="text-center text-white">
							  ...
							  <p class="gap-items-2 mb-20">
								  ...
								  <a class="btn btn-social-icon btn-round btn-outline btn-white" href="{{ route('login.google') }}"><i class="fa fa-google-plus"></i></a>
								  <a class="btn btn-social-icon btn-round btn-outline btn-white" href="{{ route('login.github') }}"><i class="fa fa-github"></i></a>
                                  <a class="btn btn-social-icon btn-round btn-outline btn-white" href="{{ route('login.facebook') }}"><i class="fa fa-facebook"></i></a>
								</p>	
							</div>
